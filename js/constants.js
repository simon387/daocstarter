...
module.exports = {
	...
	characterItemsOrder: 'character.items.order',
	setCharactersOrder: 'set-characters-order',
	teamItemsOrder: 'team.items.order',
	setTeamsOrder: 'set-teams-order',
	accountItemsOrder: 'account.items.order',
