...
const reCalc = (nItem, nRiga, refillFieldsFlag = false) => {
	...
	//console.log('evalueElement=',evalueElement)
	let ebonusElement = document.getElementById('ebonus' + nItem + nRiga);
	//console.log('ebonusElement=',ebonusElement)
	if (refillFieldsFlag) {
		refillFields(effectValue, evalueElement, ebonusElement, realm);
	}

	//effect evalue ebonus

	let e = document.getElementById('effect'+ nItem + 1)
	let v = -1;
	try {v = e.options[e.selectedIndex].value}
	catch(e) {}
	let DAOCSTARTER_G1_EFFECT = v
	...
	let DAOCSTARTER_G1_AMOUNT = v

	e = document.getElementById('ebonus'+ nItem + 1)
	v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G1_TERZA = v

	e = document.getElementById('effect'+ nItem + 2)
	v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G2_EFFECT =v
	...
	let DAOCSTARTER_G2_AMOUNT =v


		e = document.getElementById('ebonus'+ nItem + 2)
		v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G2_TERZA = v


	e = document.getElementById('effect'+ nItem + 3)
	v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G3_EFFECT = v
	...
	let DAOCSTARTER_G3_AMOUNT = v


	e = document.getElementById('ebonus'+ nItem + 3)
	v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G3_TERZA  = v


	e = document.getElementById('effect'+ nItem + 4)
	v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G4_EFFECT = v
	...
	let DAOCSTARTER_G4_AMOUNT  = v


	e = document.getElementById('ebonus'+ nItem + 4)
	v = -1;
	 try {
		v = e.options[e.selectedIndex].value
	}
	catch(e) {}
	let DAOCSTARTER_G4_TERZA = v
	

	let finalImbueResult = reCalcX(
		DAOCSTARTER_G1_EFFECT,
		DAOCSTARTER_G1_AMOUNT,
		DAOCSTARTER_G1_TERZA,
DAOCSTARTER_G2_EFFECT,
DAOCSTARTER_G2_AMOUNT,
DAOCSTARTER_G2_TERZA,
	DAOCSTARTER_G3_EFFECT,
	DAOCSTARTER_G3_AMOUNT,
	DAOCSTARTER_G3_TERZA ,
 DAOCSTARTER_G4_EFFECT,
 DAOCSTARTER_G4_AMOUNT ,
 DAOCSTARTER_G4_TERZA, realm)//(mValArrayFinal[0] + mValArrayFinal[1] + mValArrayFinal[2] + mValArrayFinal[3]) / 2;
...
const refillFields = (effectValue, evalueElement, ebonusElement, realm) => {
	//console.log("refillFields called")
	//console.log("realm=",realm)
	//console.log("effectValue=", effectValue)
	switch (effectValue) {
		case "0"://'stat':
...
DAOCSTARTER_G2_TERZA,
 ...
 DAOCSTARTER_G4_EFFECT,
 DAOCSTARTER_G4_AMOUNT ,
 DAOCSTARTER_G4_TERZA ,DAOCSTARTER_REAME
) => {
/*
console.log( 
